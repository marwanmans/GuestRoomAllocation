        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommonAreas = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Facilities = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactInfo_Phone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guests_ContactInfo_Email",
                table: "Guests",
